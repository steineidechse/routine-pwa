...
// ---------- CSS injection (keine index.html Änderung nötig) ----------
function injectStyles() {
  ...
  .rewardBtn.primary{ background:#111; color:#fff; border-color:#111; }

  .confetti{ position:fixed; inset:0; pointer-events:none; z-index:2100; }
  .conf{
